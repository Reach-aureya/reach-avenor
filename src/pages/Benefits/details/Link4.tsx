    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Align design, development, manufacturing, and marketing teams using the same digital assets. This reduces miscommunication, ensures consistency, and allows product intent to flow clearly across the entire workflow.
          </p>
