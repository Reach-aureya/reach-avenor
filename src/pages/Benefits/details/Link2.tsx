    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <h1 className="text-center text-primary text-3xl sm:text-4xl font-bold mb-8 leading-normal">
          More Persuasive and Realistic Presentations
        </h1>
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Photoreal 3D renders make it easier for stakeholders, buyers, and collaborators to understand the design intent. Clear visualization of materials, finishes, and proportions leads to stronger presentations and faster approvals.
          </p>
