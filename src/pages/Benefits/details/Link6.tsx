    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <h1 className="text-center text-primary text-3xl sm:text-4xl font-bold mb-8 leading-normal">
          High-Quality Assets for Marketing and Sales
        </h1>
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            A single 3D bag model can be used to generate visuals for catalogs, campaigns, e-commerce platforms, and presentations. This ensures consistent branding while reducing the need for separate photoshoots.
          </p>
