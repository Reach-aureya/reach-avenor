    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Use digital prototypes to minimize multiple rounds of physical samples. This saves time, reduces material waste, and creates a more efficient and cost-effective product development process.
          </p>
